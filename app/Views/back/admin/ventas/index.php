            ...
            <div class="col-md-3">
                <div class="card border-0 shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <h4 class="mt-2"><?= count(array_filter($ventas, function($v) { return date('Y-m-d') === date('Y-m-d', strtotime($v['fecha_factura'])); })) ?></h4>
                            ...
                            <?php if (empty($ventas)): ?>
                                <tr>
                                    <td colspan="7" class="text-center py-5">
                                        ...
                                        <p class="text-muted">Las ventas aparecerán aquí cuando los clientes realicen compras</p>
                                    </td>
                                </tr>
                            <?php else: ?>
                                <?php foreach ($ventas as $venta): ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?= base_url('panel/venta/' . $venta['id_factura']) ?>" 
