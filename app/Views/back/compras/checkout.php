                ...
                <div class="col-lg-4">
                    ...
                    <div class="card sticky-top mb-3" style="top: 100px;">
                        ...
                        <div class="card-body">
                            ...
                            <!-- Botón de MercadoPago mejorado -->
                            <div class="card border-0 shadow-sm mb-3">
                                <div class="card-body text-center">
                                    <div class="mb-3">
                                        <!-- Ícono SVG de MercadoPago -->
                                        <div class="mercadopago-icon" style="display: inline-block; width: 80px; height: 80px;">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 700 700" style="width: 100%; height: 100%;">
                                                <defs>
                                                    <style>
                                                        .cls-1 { fill: #0a0080; }
                                        ...
                                        <h6 class="mb-1">Pagar con MercadoPago</h6>
                                        <p class="text-muted small mb-0">Método de pago seguro y confiable</p>
                                    </div>
                                    <a href="<?= base_url('mercadopago/create') ?>" class="btn btn-primary w-100">
                                        <i class="fas me-2"></i> Continuar con MercadoPago
                                    </a>
                                </div>
                            </div>
