        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="login-box">
                    ...
                    <p class="text-center mb-4">¡Bienvenido de nuevo! Accede a tu cuenta para continuar tu viaje fitness</p>
                    
                    <form method="post" action="<?php echo base_url('/enviarlogin')?>" class="login-form">
                        <div class="mb-4">
                            <label for="exampleInputEmail1" class="form-label">CORREO ELECTRÓNICO</label>
                            <div class="input-group">
                                <span class="input-group-text"><i class="fas fa-envelope"></i></span>
                                <input name="email" type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="tu@email.com">
                            </div>
                        ...
                        <div class="text-center links-container">
                            ...
                            <a href="<?= base_url('registro') ?>" class="d-block">¿Aún no tienes cuenta? ¡Regístrate ahora!</a>
                        </div>
                    </form>
                </div>
            </div>
