    ...
    <div class="container">
        ...
        <div class="order-lg-2 nav-btns d-flex align-items-center">
            <button type="button" class="btn position-relative me-2 me-lg-3" onclick="abrirCarrito()">
                ...
                <span class="position-absolute top-0 start-100 translate-middle badge bg-danger rounded-pill" id="cart-count">0</span>
            </button>
...
<div class="search-overlay" id="searchOverlay" style="display: none;">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <form action="<?= base_url('productos/buscar') ?>" method="GET" class="search-form">
                    <div class="input-group input-group-lg">
                        <input type="text" name="q" class="form-control" placeholder="Buscar productos, categorías..." 
                ...
                <div class="search-suggestions mt-3">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <a href="<?= base_url('productos/buscar?q=whey') ?>" class="badge bg-light text-dark text-decoration-none">Whey Protein</a>
                        <a href="<?= base_url('productos/buscar?q=creatina') ?>" class="badge bg-light text-dark text-decoration-none">Creatina</a>
                        <a href="<?= base_url('productos/buscar?q=colageno') ?>" class="badge bg-light text-dark text-decoration-none">Colágeno</a>
                        <a href="<?= base_url('productos/buscar?q=shaker') ?>" class="badge bg-light text-dark text-decoration-none">Shaker</a>
                        <a href="<?= base_url('productos/buscar?q=proteina+vegana') ?>" class="badge bg-light text-dark text-decoration-none">Proteína Vegana</a>
                    </div>
                </div>
            </div>
        </div>
