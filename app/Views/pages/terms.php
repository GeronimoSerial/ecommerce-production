            ...
            <div class="col-12">
                ...
                <ul class="nav nav-tabs mb-4" id="termsTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active text-black" id="general-tab" data-bs-toggle="tab" data-bs-target="#general" type="button" role="tab" aria-selected="true">General</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link text-black" id="privacy-tab" data-bs-toggle="tab" data-bs-target="#privacy" type="button" role="tab" aria-selected="false">Privacidad</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link text-black" id="sales-tab" data-bs-toggle="tab" data-bs-target="#sales" type="button" role="tab" aria-selected="false">Ventas</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link text-black" id="warranty-tab" data-bs-toggle="tab" data-bs-target="#warranty" type="button" role="tab" aria-selected="false">Garantías</button>
                    </li>
                </ul>
                    ...
                    <div class="tab-pane fade show active" id="general" role="tabpanel">
                        <div class="card border-0 shadow-sm">
                            <div class="card-body p-4">
                                ...
                                <p class="text-muted mb-4">Al acceder y utilizar este sitio web, usted acepta estos términos y condiciones en su totalidad. Si no está de acuerdo con estos términos y condiciones o alguna parte de estos, no debe utilizar este sitio web.</p>

                                <h4 class="fs-5 fw-bold mb-3">2. Uso del Sitio</h4>
                                <p class="text-muted mb-4">Este sitio web está destinado únicamente a personas mayores de 18 años. Al utilizar este sitio web, usted garantiza que tiene al menos 18 años de edad.</p>

                                <h4 class="fs-5 fw-bold mb-3">3. Propiedad Intelectual</h4>
                                <p class="text-muted mb-4">Todo el contenido de este sitio web, incluyendo textos, gráficos, logos, imágenes y software, está protegido por derechos de autor y es propiedad de FitSyn o de sus proveedores de contenido.</p>

                                <h4 class="fs-5 fw-bold mb-3">4. Modificaciones</h4>
                                <p class="text-muted">Nos reservamos el derecho de modificar estos términos y condiciones en cualquier momento. Los cambios entrarán en vigor inmediatamente después de su publicación en el sitio web.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="privacy" role="tabpanel">
                        <div class="card border-0 shadow-sm">
                            <div class="card-body p-4">
                                ...
                                <p class="text-muted">Implementamos medidas de seguridad para proteger su información personal contra acceso, modificación, divulgación o destrucción no autorizada.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="sales" role="tabpanel">
                        <div class="card border-0 shadow-sm">
                            <div class="card-body p-4">
                                ...
                                <p class="text-muted mb-4">Al realizar una compra en nuestro sitio web, usted confirma que:</p>
                                <ul class="text-muted mb-4">
                                    <li>Los productos serán utilizados de acuerdo con las instrucciones del fabricante</li>
                                ...
                                <p class="text-muted mb-4">
                                    Todos los precios están en pesos argentinos e incluyen IVA. Nos reservamos el derecho de modificar los precios en cualquier momento.
                                ...
                                <p class="text-muted mb-4">
                                    Los tiempos de entrega son estimados y pueden variar según la ubicación y el método de envío seleccionado.
                                    No nos hacemos responsables por retrasos causados por eventos fuera de nuestro control.
                                </p>

                                <h4 class="fs-5 fw-bold mb-3">4. Cancelaciones</h4>
                                <p class="text-muted">Las cancelaciones son posibles dentro de las 24 horas posteriores a la realización del pedido, siempre que el producto no haya sido enviado.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card border-0 shadow-sm">
                            <div class="card-body p-4">
                                ...
                                <p class="text-muted mb-4">
                                    ...
                                    Si el producto presenta algún defecto de fabricación, será reemplazado sin costo adicional.
                                </p>
                                ...
                                <p class="text-muted">Para cualquier consulta sobre garantías o soporte post-venta, puede contactarnos a través de:</p>
